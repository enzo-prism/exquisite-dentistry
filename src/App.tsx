...
const SantaMonicaDentalImplants = lazy(() => import("@/pages/SantaMonicaDentalImplants"));
...
const SmileMakeoverLosAngeles = lazy(() => import("@/pages/SmileMakeoverLosAngeles"));
...
const AppRoutes = () => {
  ...
  return (
    <>
      ...
      <main id="main-content" className="min-w-0 flex-grow overflow-x-clip">
        {!isSitemapPage ? (
          <PageTransition>
            <Routes>
