    ...
    <>
      ...
      <div className="min-h-screen page-transition-in">
        <VideoHero
          ...
          subtitle="Get comprehensive answers about our Los Angeles practice near Beverly Hills, treatment procedures, insurance coverage, and what to expect at your visit."
