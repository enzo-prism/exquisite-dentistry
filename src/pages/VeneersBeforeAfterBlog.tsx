...
const blogPost: BlogPost = {
  ...
  excerpt:
    'A transparent look at what porcelain veneers can achieve in Los Angeles, complete with real, anonymized before-and-after visuals pulled directly from our smile gallery.',
  ...
  seoDescription:
    'See how porcelain veneers transform smiles in Los Angeles. This no-BS guide explains what veneers fix, how to read before-and-after photos, and how to plan your own smile upgrade.'
};

const VeneersBeforeAfterBlog = () => {
  ...
  return (
    <>
      ...
      <PageSEO
        ...
        keywords="veneers before after Los Angeles, porcelain veneers gallery, cosmetic dentist West Hollywood, smile transformation photos"
        ogType="article"
        articleAuthor={blogPost.author}
        articlePublishedTime={new Date(blogPost.date).toISOString()}
      />
      ...
      <article className="bg-white">
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-10">
              <div>
                ...
                <p className="text-gray-600 mt-3 max-w-2xl">
                  Layering, translucency, and incisal texture are easiest to see up close. These cases show how veneers
                  can refine chips, gaps, and worn edges without resorting to bulky shapes.
                </p>
              </div>
              <Button variant="outline" asChild>
        ...
        <section className="max-w-5xl mx-auto px-4 py-12 md:py-16 space-y-12">
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white shadow-sm rounded-lg p-6 border border-slate-100">
                <h3 className="text-xl font-semibold mb-3">Conservative aesthetic</h3>
                <p className="text-gray-600">
                  Teeth retain natural character. The goal is a believable enhancement—not a copy-and-paste smile.
                </p>
              </div>
              <div className="bg-white shadow-sm rounded-lg p-6 border border-slate-100">
                <h3 className="text-xl font-semibold mb-3">Shade & face harmony</h3>
                <p className="text-gray-600">
                  Shades are selected for skin tone, lip tone, and personality so the smile fits the face effortlessly.
                </p>
              </div>
              <div className="bg-white shadow-sm rounded-lg p-6 border border-slate-100">
                <h3 className="text-xl font-semibold mb-3">Precision smile design</h3>
                <p className="text-gray-600">
                  Smile arcs, midlines, and tooth lengths are planned digitally before any porcelain is fabricated.
                </p>
              </div>
              <div className="bg-white shadow-sm rounded-lg p-6 border border-slate-100">
                <h3 className="text-xl font-semibold mb-3">Attention to micro-details</h3>
                <p className="text-gray-600">
                  Line angles, edge definition, texture, and translucency are refined so veneers look indistinguishable
                  from natural enamel.
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Patients choose porcelain veneers for confidence, symmetry, youthful energy, and long-term stain
              resistance. Common treatment ranges are 2, 4, 6, or 8+ veneers depending on how many teeth show when you
              smile—something your consultation will determine precisely.
            </p>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <div>
            <h2 className="text-3xl font-semibold mb-4">Veneer FAQs</h2>
            <div className="space-y-4">
              {[
                {
                  q: 'Do veneers look fake?',
                  a: 'Not when they are designed with layered porcelain, natural texture, and a shade tailored to your skin tone—as seen throughout the gallery.'
                },
                {
                  q: 'Can veneers close gaps or fix chips?',
                  a: 'Yes. Minor spacing, chips, or uneven lengths are some of the most common improvements visible in the sliders above.'
                },
                {
...
export default VeneersBeforeAfterBlog;
