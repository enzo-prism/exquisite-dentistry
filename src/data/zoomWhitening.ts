...
export const ZOOM_WHITENING_FAQS: FAQItem[] = [
  {
  ...
  },
  {
    ...
    answer:
      'Results commonly last several months to a couple of years, depending on diet, coffee/tea/wine habits, and home care. Touch-ups and regular cleanings help maintain a brighter shade longer.'
  },
  {
    question: 'Should I get a cleaning before Zoom whitening?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Whitening gel only lightens natural tooth enamel. Veneers, crowns, and fillings won’t change color, so we’ll plan around any visible restorations to keep your final shade looking consistent.'
  }
];
