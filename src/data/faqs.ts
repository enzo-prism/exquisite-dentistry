...
export const faqs: FAQItem[] = [
  {
    ...
    answer:
      "You can always expect to be treated like a VIP. Our office looks, sounds, and smells like a day spa. You'll be warmly greeted and offered freshly-brewed coffee, water, or herbal tea as soon as you come through the door. Enjoy a soft blanket, neck pillow, and noise-canceling headphones as you relax in a comfortable treatment chair.\n\nWe value your time and get right to work for you. Dr. Aguil will patiently keep you informed and involved in your treatment."
  },
  {
    question: "What If I'm a New Patient?",
    answer:
      "Welcome! We're excited to see you! Please arrive 15 minutes early to complete paperwork for your first appointment. Or, you can complete our dental patient forms online and print or email them back to us to save time."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Exquisite Dentistry is focused on caring for the treatment and comfort of adults. Though we would be happy to recommend a pediatric dental office for your children."
  },
  {
  ...
  {
    question:
      "What Types of Imaging (X-Rays, CT Scan) are available at Exquisite Dentistry?",
    answer:
      "We use digital imaging for routine x-rays and 3D imaging for more advanced diagnosis. Our iTero scanner takes a digital impression of your mouth and records the movement of teeth over time, something that happens to everyone as we age.\n\niTero scanning also allows us to create digital impressions for crowns and bridges. This is great news for our patients because in many cases, we won't have to use traditional trays lined with a gooey material to create these impressions. This is another way our advanced technology helps to make your visit more comfortable."
  },
  {
    question: "What if I Can't Make it to My Appointment?",
    answer:
      "Please provide a notice within 48 hours to cancel or reschedule an appointment. Cancellations within 48 hours will be subject to a cancellation fee."
  },
  {
