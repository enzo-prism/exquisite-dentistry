...
export const CANONICAL_URLS = {
  ...
  INVISALIGN: `${BASE_URL}/invisalign/`,
  VENEERS_LOS_ANGELES: `${BASE_URL}/veneers-los-angeles/`,
  TEETH_WHITENING: `${BASE_URL}/teeth-whitening/`,
  DENTAL_IMPLANTS: `${BASE_URL}/dental-implants/`,
  COSMETIC_DENTISTRY: `${BASE_URL}/cosmetic-dentistry/`,
  EMERGENCY_DENTIST: `${BASE_URL}/emergency-dentist/`,
