          ...
          <div className="space-y-6 md:space-y-8">
            <div className="bg-gold/10 p-6 rounded-sm border-l-4 border-gold shadow-md">
              ...
              <p className="text-gray-700">
                “My goal is to make every patient feel comfortable and cared for throughout their visit.”
                <span className="mt-2 block text-sm font-semibold text-gray-600">Dr. Alexie Aguil</span>
              </p>
            </div>
