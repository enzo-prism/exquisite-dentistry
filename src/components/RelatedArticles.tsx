...
// Lightweight blog index (no post bodies) generated by scripts/generate-blog-index.ts.
// Importing this instead of the full blog dataset keeps ~385KB of post content
// out of every service/money-page bundle that renders related articles.
...
const publishedPosts = blogIndex as BlogIndexEntry[];
